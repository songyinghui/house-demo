package com.syh.senior5.config;
...
// 全局配置
        ...
        gc.setOutputDir(projectPath+"\\house-service" + "/src/main/java");
        gc.setAuthor("宋英辉");
        gc.setOpen(false);
        mpg.setGlobalConfig(gc);
// 数据源配置
        DataSourceConfig dsc = new DataSourceConfig();
        dsc.setUrl("jdbc:mysql://localhost:3306/ykb?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai");
...
// 自定义输出文件名 ， 如果你 Entity 设置了前后缀、此处注意 xml 的名称会跟着发生变化！！
                return projectPath+"\\house-service" + "/src/main/resources/mappers/" /*+pc.getModuleName()
